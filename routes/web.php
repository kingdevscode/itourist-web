...
Route::middleware(['auth', 'add-user'])->group(function () {
    ...
    Route::name('tourisme')->namespace('')->prefix('/tourisme')->group(function (){
        ...
        Route::name('note.')->namespace('')->prefix('/note')->group(function (){
            ...
            Route::get('/create-note', 'App\Http\Controllers\NoteController@create')->name('note-create');
        ...
        Route::name('note-article.')->namespace('')->prefix('/note-article')->group(function (){
            ...
            Route::get('/create-note-article', 'App\Http\Controllers\NoteArticleController@create')->name('note-article-create');
            Route::get('/delete-note-article', 'App\Http\Controllers\NoteArticleController@destroy')->name('note-article-delete');
        });
        ...
        Route::name('note-site.')->namespace('')->prefix('/note-site')->group(function (){
            ...
            Route::get('/create-note-site', 'App\Http\Controllers\NoteSiteController@create')->name('note-site-create');
        ...
        Route::name('note-logement.')->namespace('')->prefix('/note-logement')->group(function (){
            ...
            Route::get('/create-note-logement', 'App\Http\Controllers\NoteLogementController@create')->name('note-logement-create');
        ...
        Route::name('commentaire.')->namespace('')->prefix('/commentaire')->group(function (){
            ...
            Route::get('/create-commentaire', 'App\Http\Controllers\CommentaireController@create')->name('commentaire-create');
        ...
        Route::name('commentaire-site.')->namespace('')->prefix('/commentaire-site')->group(function (){
            ...
            Route::get('/create-commentaire-site', 'App\Http\Controllers\CommentaireSiteController@create')->name('commentaire-site-create');
        ...
        Route::name('commentaire-logement.')->namespace('')->prefix('/commentaire-logement')->group(function (){
            ...
            Route::get('/create-commentaire-logement', 'App\Http\Controllers\commentaireLogementController@create')->name('commentaire-logement-create');
